...
## Готовый файл: Структура сайта (Draw.io → Visio)

Файл **`docs/structure-site.drawio`** можно открыть в [app.diagrams.net](https://app.diagrams.net), отредактировать и экспортировать в Visio:
