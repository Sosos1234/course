...
-- Начальные данные: этажи
INSERT INTO `floors` (`number`, `name`, `description`) VALUES
(-1, 'Подземный этаж', 'Парковка, вход со стороны парковки'),
(1, '1 этаж', 'Основной торговый уровень'),
(2, '2 этаж', 'Торговая галерея'),
(3, '3 этаж', 'Торговые павильоны'),
(4, '4 этаж', 'Услуги и развлечения'),
(5, '5 этаж', 'Фитнес, образование');
